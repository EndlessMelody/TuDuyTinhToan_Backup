...
20. [Messages (Direct)](#20-messages-direct)
21. [Culture Guide](#21-culture-guide)
...
|---|---|---|---|
| Auth & Sessions | `/auth` | 9 | 2 ✅ + 7 🆕 |
| Users & Profile | `/users` | 6 | 1 ✅ + 5 🆕 |
| Locations | `/locations` | 4 | 4 🆕 |
| Discovery | `/feed` | 2 | 1 ✅ + 1 🆕 |
| Interactions | `/interactions` | 2 | 1 ✅ + 1 🆕 |
| Recommendations | `/recommendations` | 3 | 1 ✅ + 2 🆕 |
| Groups & Lobbies | `/groups` | 14 | 14 🆕 |
| Tours | `/tours` | 6 | 6 🆕 |
| Posts | `/posts` | 5 | 5 🆕 |
| Reels | `/reels` | 4 | 4 🆕 |
| Comments | (nested) | 5 | 5 🆕 |
...
| Deals | `/deals` | 3 | 3 🆕 |
| Gamification | `/badges` | 7 | 7 🆕 |
| Settings | `/settings` | 2 | 2 🆕 |
| Media / Uploads | `/media` | 1 | 1 🆕 |
| Challenges | `/challenges` | 12 | 12 🆕 |
| Messages | `/messages` | 8 | 8 🆕 |
| Culture Guide | `/culture` | 3 | 3 🆕 |
| **Tổng** | | **111** | **7 ✅ + 104 🆕** |
...
4. **Pagination:** Mọi list endpoint đều có `limit/offset` hoặc `cursor`. Không bao giờ `SELECT *` không giới hạn.
