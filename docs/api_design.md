...
### `POST /api/v1/groups/{group_id}/recommend` 🆕

**Minimax Referee** — Khi tất cả member ready, chạy thuật toán:
`min(max_i |Score_i − Score_ideal|)`

Hệ thống tổng hợp vector tất cả thành viên, tìm địa điểm tối ưu cho nhóm.
